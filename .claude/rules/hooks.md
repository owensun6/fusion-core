...
1. **上下文静默注入 (FUSION_INDEX_AUTOLOAD)**: 系统已在前置 Hook 中自动将你当前所处阶段的环境变量与 FUSION_INDEX.md 地图注入。**你不必再浪费 Token 去主动抓取地图**，请直接行动。
2. **密钥扫描**: 当前变更的内容中，是否携带了人类世界的真实云密钥、DB 密码？(若有，立即终止！)
