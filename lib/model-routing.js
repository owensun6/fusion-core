...
const MODEL_ROUTING_MATRIX = Object.freeze({
  ...
  pm: Object.freeze({
    ...
    capabilities: Object.freeze(['requirements', 'prd', 'bdd', 'user-stories']),
  }),
  lead: Object.freeze({
    model: 'opus',
    tier: 'heavy',
    reason: '架构级思考需要最强推导能力',
    capabilities: Object.freeze(['architecture', 'system-design', 'task-planning', 'adr']),
  }),
  // 厚上下文兵种 — 核心结构设计
  'db-schema-designer': Object.freeze({
    ...
    capabilities: Object.freeze(['database', 'schema', 'migration', 'orm']),
  }),
  'be-domain-modeler': Object.freeze({
    model: 'sonnet',
    tier: 'heavy',
    reason: '领域建模需要深度业务理解',
    capabilities: Object.freeze(['domain-logic', 'business-rules', 'validation']),
  }),
  'be-ai-integrator': Object.freeze({
    model: 'sonnet',
    tier: 'heavy',
    reason: 'AI 集成需要精确推理',
    capabilities: Object.freeze(['ai-integration', 'llm', 'prompt-engineering', 'embedding']),
  }),
  // 中度兵种 — 测试与审查
  'be-api-router': Object.freeze({
    ...
    capabilities: Object.freeze(['rest-api', 'graphql', 'route-definition', 'swagger']),
  }),
  'qa-01': Object.freeze({
    model: 'sonnet',
    tier: 'medium',
    reason: '语法检查涉及长代码段检索',
    capabilities: Object.freeze(['syntax-check', 'code-style', 'linting']),
  }),
  'qa-02': Object.freeze({
    model: 'sonnet',
    tier: 'medium',
    reason: '规范合规需要上下文理解',
    capabilities: Object.freeze(['spec-compliance', 'contract-validation']),
  }),
  'qa-03': Object.freeze({
    model: 'sonnet',
    tier: 'medium',
    reason: '安全审计不可降级',
    capabilities: Object.freeze(['security-audit', 'owasp', 'vulnerability-scan']),
  }),
  'iv-01': Object.freeze({
    model: 'sonnet',
    tier: 'medium',
    reason: '契约验证需要精确比对',
    capabilities: Object.freeze(['e2e-test', 'connectivity', 'playwright']),
  }),
  'iv-02': Object.freeze({
    model: 'sonnet',
    tier: 'medium',
    reason: '数据流追踪需要上下文',
    capabilities: Object.freeze(['data-flow', 'serialization', 'cache-invalidation']),
  }),
  // 轻量兵种 — 纯体力活
  'fe-ui-builder': Object.freeze({
    ...
    capabilities: Object.freeze(['html', 'css', 'react-component', 'ui-layout']),
  }),
  'fe-logic-binder': Object.freeze({
    model: 'haiku',
    tier: 'light',
    reason: '已有 Swagger 契约，只需写 Fetch',
    capabilities: Object.freeze(['api-binding', 'state-management', 'fetch', 'swr']),
  }),
});
...
function matchByCapabilities(requiredCapabilities) {
  if (!Array.isArray(requiredCapabilities)) return Object.freeze([]);
  const results = [];
...
function matchRoles(descriptor) {
  if (!descriptor || typeof descriptor !== 'object') return Object.freeze([]);
